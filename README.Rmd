...
```{r}
standard <- import_fbref_standard("standard.csv")
shooting <- import_fbref_shooting("shooting.csv")

master <- merge_fbref_tables(standard, shooting)
...
See the full workflow in the vignette:
- [From FBref to Master Table](articles/from-fbref-to-master-table.html)
