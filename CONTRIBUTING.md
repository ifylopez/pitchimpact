...
This outlines how to propose a change to pitchimpact. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ifylopez/pitchimpact", fork = TRUE)`.
...
Please note that the pitchimpact project is released with a [Contributor
Code of
